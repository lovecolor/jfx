    ...
    <div className="App">
      <div class="left">
        ...
        <div class="left-down">
          ...
          <p class="left-down-textdown">My Name is {me.name}</p>
        </div>
      </div>
      <div class="right">
        <div class="right-up">
